...
class Client {
  constructor() {
    ...
    let host = _ref$host === undefined ? _index.rpc.host || 'localhost' : _ref$host;
    var _ref$network = _ref.network;
    let network = _ref$network === undefined ? _index.rpc.network || 'mainnet' : _ref$network;
    var _ref$password = _ref.password;
    let password = _ref$password === undefined ? _index.rpc.password || null : _ref$password,
        port = _ref.port;
    var _ref$ssl = _ref.ssl;
    let ssl = _ref$ssl === undefined ? _index.rpc.ssl || false : _ref$ssl;
    var _ref$timeout = _ref.timeout;
    let timeout = _ref$timeout === undefined ? 30000 : _ref$timeout;
    var _ref$username = _ref.username;
    let username = _ref$username === undefined ? _index.rpc.username || null : _ref$username,
    ...
    if (_index.rpc.certpath) {
      // Load the certificate
      this.agentOptions = {
        /* eslint no-sync: "off"*/
        ca: _fs2.default.readFileSync(_index.rpc.certpath)
      };
    }
